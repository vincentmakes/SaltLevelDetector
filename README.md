...
Bark is a free iOS app which can be installed on any Apple mobile device and is meant to receive notifications. 

For Android users, a topic for the app NTFY is generated by the esp32 and one can subscribe to it from a mobile device to receive the notifications.
